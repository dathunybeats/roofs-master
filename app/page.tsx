    ...
    <footer className="w-[97vw] mx-auto bg-[rgba(16,16,20,255)] rounded-t-2xl pt-12 pb-6 px-2 mt-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between gap-12">
        ...
        <div className="flex-1 mb-8 md:mb-0">
          <div className="text-4xl font-bold text-white mb-2">Straight Flow Roofing</div>
        </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm gap-2">
        <div>&copy; {new Date().getFullYear()} Straight Flow Roofing. All rights reserved.</div>
  ...
  return (
    <section className="max-w-7xl mx-auto py-20 px-4" id="testimonials">
      ...
      >
        ...
        <p className="text-lg text-gray-600 text-center max-w-2xl">Hear from our happy clients about their experience working with Straight Flow Roofing and the quality of our craftsmanship.</p>
      </motion.div>
  ...
  const projects = [
    {
      ...
      testimonial:
        "Straight Flow Roofing replaced our old roof quickly and professionally. The team was friendly and left everything tidy. Highly recommend!",
      author: {
        name: "Laura Davies",
    ...
    },
    {
      ...
      testimonial:
        "Straight Flow Roofing delivered a top-quality flat roof for our business. The installation was smooth and the results are excellent.",
      author: {
        name: "Emily Carter",
        img: "https://randomuser.me/api/portraits/women/22.jpg",
      },
    },
    {
      ...
      testimonial:
        "After a storm, Straight Flow Roofing repaired our roof and prevented further leaks. Great service and communication!",
      author: {
        name: "Daniel Foster",
        img: "https://randomuser.me/api/portraits/men/65.jpg",
      },
    ...
    <div className="font-sans bg-gray-50 text-gray-900">
      ...
      <header className="sticky top-0 z-50" style={{ background: 'rgba(16,16,20,1)' }}>
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <a href="#" className="text-2xl font-bold tracking-tight text-white">Straight Flow Roofing</a>
          {/* Desktop Nav */}
          ...
          */}
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              >
                <div className="text-2xl font-bold tracking-tight text-white">Straight Flow Roofing</div>
                <button
