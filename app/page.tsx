...
function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes, Weaver Roofing is fully licensed and insured for all roofing work. Your property is in safe hands."
    },
    {
    ...
    <footer className="w-[97vw] mx-auto bg-[rgba(16,16,20,255)] rounded-t-2xl pt-12 pb-6 px-2 mt-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-start md:justify-between gap-12">
        ...
        <div className="flex-1 mb-8 md:mb-0">
          <div className="text-4xl font-bold text-white mb-2">Weaver Roofing</div>
        </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm gap-2">
        <div>&copy; {new Date().getFullYear()} Weaver Roofing. All rights reserved.</div>
...
function TestimonialsSection() {
  const testimonials = [
    {
      text: "Weaver Roofing replaced our leaking roof and the results are fantastic. The crew was professional, efficient, and left our property spotless. Highly recommended!",
      name: "James Richardson",
      img: "https://randomuser.me/api/portraits/men/32.jpg",
    },
    {
      text: "We needed emergency repairs after a storm and Weaver Roofing responded immediately. They fixed the damage and gave us peace of mind. Great service!",
    ...
    {
      text: "From the first consultation to the final inspection, Weaver Roofing delivered on every promise. Our roof replacement was smooth and stress-free!",
      name: "Charlotte Harris",
      img: "https://randomuser.me/api/portraits/women/68.jpg",
    },
    {
      text: "Fantastic workmanship! Weaver Roofing repaired our gutters and fixed a persistent leak. Everything was explained clearly and done on time.",
      name: "Oliver Bennett",
      img: "https://randomuser.me/api/portraits/men/12.jpg",
    },
    {
      text: "Weaver Roofing did an incredible job on our commercial flat roof. The quality is excellent and the team was a pleasure to work with.",
      name: "Emily Carter",
  ...
  return (
    <section className="max-w-7xl mx-auto py-20 px-4" id="testimonials">
      ...
      >
        ...
        <p className="text-lg text-gray-600 text-center max-w-2xl">Hear from our happy clients about their experience working with Weaver Roofing and the quality of our craftsmanship.</p>
      </motion.div>
  ...
  const projects = [
    {
      ...
      testimonial:
        "Weaver Roofing replaced our old roof quickly and professionally. The team was friendly and left everything tidy. Highly recommend!",
      author: {
        name: "Laura Davies",
    ...
    },
    {
      ...
      testimonial:
        "Weaver Roofing delivered a top-quality flat roof for our business. The installation was smooth and the results are excellent.",
      author: {
        name: "Emily Carter",
        img: "https://randomuser.me/api/portraits/women/22.jpg",
      },
    },
    {
      ...
      testimonial:
        "After a storm, Weaver Roofing repaired our roof and prevented further leaks. Great service and communication!",
      author: {
        name: "Daniel Foster",
        img: "https://randomuser.me/api/portraits/men/65.jpg",
      },
    ...
    <div className="font-sans bg-gray-50 text-gray-900">
      ...
      <header className="sticky top-0 z-50" style={{ background: 'rgba(16,16,20,1)' }}>
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <a href="#" className="text-2xl font-bold tracking-tight text-white">Weaver Roofing</a>
          {/* Desktop Nav */}
          ...
          */}
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              >
                <div className="text-2xl font-bold tracking-tight text-white">Weaver Roofing</div>
                <button
